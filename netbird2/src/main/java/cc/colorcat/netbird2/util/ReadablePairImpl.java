...
public abstract class ReadablePairImpl {
    ...
    protected boolean realAdd(String name, String value) {
        return names.add(name) && values.add(value);
    }

    protected void realRemoveAll(String name) {
    ...
    protected abstract boolean compareName(String name, String anotherName);
}
